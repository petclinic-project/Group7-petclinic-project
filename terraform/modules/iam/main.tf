  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:ecr:${var.aws_region}:${var.aws_account_id}:repository/${var.project}-${var.environment}-*"
      },
      {
        Sid    = "EKSAccess"
        Effect = "Allow"
        ...
        Resource = "arn:aws:eks:${var.aws_region}:${var.aws_account_id}:cluster/${var.project}-${var.environment}-eks"
      }
    ]
  })
}
...
resource "aws_iam_role" "argocd" {
  name = "${var.project}-${var.environment}-argocd-role"
